...
if ( episode_players.length > 0 ) {
	episode_players.forEach( function( player ) {
		...
		player.parentElement.querySelector( ".media-play-pause" ).addEventListener( "click", function(e) {
...
// Pause background videos on mobile, when browser tab is inactive or when not in viewport
