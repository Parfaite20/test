                        ...
                        <ul class="nk-menu nk-menu-md">
                            ...
                            <li class="nk-menu-item has-sub">
                                ...
                                <ul class="nk-menu-sub">
                                    ...
                                    <li class="nk-menu-item">
                                        <a href="{{route('auteurs.create')}}" class="nk-menu-link"><span class="nk-menu-text">Ajouter livre</span></a>
                                    </li>
                                    <li class="nk-menu-item">
                        ...
                        <ul class="nk-menu nk-menu-md">
                            ...
                            <li class="nk-menu-item has-sub">
                                ...
                                <ul class="nk-menu-sub">
                                    ...
                                    <li class="nk-menu-item">
                                        <a href="{{route('auteurs.create')}}" class="nk-menu-link"><span class="nk-menu-text">Ajouer livre</span></a>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="{{route('auteur.cate')}}" class="nk-menu-link"><span class="nk-menu-text">Categories</span></a>
                                    </li>
